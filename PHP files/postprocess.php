...
// the second parameter "W" Gives us permission write in this file
	$f = fopen("user/$u/profile.txt", 'w') or die();
...
//mamp users connection
		$cnt = mysqli_connect("localhost:3306", "root", "root", "PLANK");
//xampp users connection
		//$connection = mysqli_connect("localhost", "root", "", "PLANK");

		$qry = "INSERT INTO WORKOUT (name, email, user) VALUES ('$dan', '$testing@tester.com','$1234');";
